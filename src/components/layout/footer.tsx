    ...
    <footer className="mt-auto border-t border-border/60 bg-card">
      <div className="mx-auto max-w-5xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <h3 className="font-heading text-sm font-semibold">바로가기</h3>
          ...
          <div>
            <h3 className="font-heading text-sm font-semibold">찾아오시는 길</h3>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              서울시 종로구 돈화문로 11길 29
              <br />
              1층 1호 (돈의동, 낙원오피스텔)
        ...
        <p className="text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} 놓다 익선동. All rights reserved.
        </p>
      </div>
    </footer>
  );
